...
# This implementation of Adamw integrates the GaLore projector to perform gradient projection
        ...
        for group in self.param_groups:
            for p in group["params"]:
                ...
                if "rank" in group:
                    ...
                    #print('*' * 50)
                    #print(f"Before projection: grad.shape={grad.shape}")
                    grad = state["projector"].project(grad, state["step"])
                    #print(f"After projection: grad.shape={grad.shape}")
                    #print('*' * 50)
                ...
                if "rank" in group:
                    #print(f"Before project back: norm_grad_.shape={norm_grad.shape}")
                    norm_grad = state["projector"].project_back(norm_grad)
                    #print(f"After project back: norm_grad_.shape={norm_grad.shape}")
